...
export function LogOut(){
    return(
        <div className="hidden fixed top-0 right-0 w-full min-h-screen grid justify-center items-center bg-black/50 z-99">
            <div className="px-5 py-4 bg-surface rounded-md grid gap-5 ">
                ...
                <div className='flex justify-between'>
                    <button className='px-5 py-2 border border-border rounded-md font-medium'>Cancel</button>
